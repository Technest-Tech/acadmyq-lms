...
final class OrderController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $result = DataTable::paginate($query, $request, [
            'idColumn' => 'o.id',
            'searchable' => ['o.order_number', 'o.buyer_name', 'o.buyer_email', 'o.buyer_phone', 'c.title'],
            'sortable' => [
        ...
        return response()->json([
            'order' => $this->rowDto($order) + [
                ...
                'enrollment' => $enrollment === null ? null : [
                    ...
                    'enrolled_at' => $this->iso($enrollment->enrolled_at),
                    'from_order' => $enrollment->source_order_id !== null,
                    'from_code' => $enrollment->source_code_id !== null,
                ],
            ],
            'receipts' => $receipts,
        ]);
    ...
    private function rowDto(object $r): array
    {
        return [
            ...
            'course_slug' => $r->course_slug ?? null,
